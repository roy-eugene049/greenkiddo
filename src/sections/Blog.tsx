    ...
    <section className="bg-black dark:black">
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          <div className="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
            <h2 className="mb-4 text-3xl lg:text-4xl tracking-tight font-extrabold text-green-ecco">
              Our Blog
            </h2>
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            <article className="p-6 backdrop-blur-md bg-black rounded-lg border border-gray-700 shadow-md dark:bg-black">
              ...
              <p className="mb-5 font-light text-gray-400">
                Static websites are now used to bootstrap lots of websites and are becoming the basis for a variety of tools that influence both web designers and developers.
              </p>
              <div className="flex justify-between items-center">
                ...
                <a
                  href="#"
                  className="inline-flex items-center font-medium text-green-ecco hover:underline"
                >
                  Read more
                  <svg
            ...
            <article className="p-6 backdrop-blur-md bg-black rounded-lg border border-gray-700 shadow-md dark:bg-black">
              ...
              <p className="mb-5 font-light text-gray-400">
                Static websites are becoming the basis for tools that influence both web designers and developers.
              </p>
              <div className="flex justify-between items-center">
                <div className="flex items-center space-x-4">
                  <img
